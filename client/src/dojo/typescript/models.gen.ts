...
export const schema: SchemaType = {
	starkludo: {
		Game: {
			fieldOrder: ['id', 'created_by', 'game_status', 'game_mode', 'player_green', 'player_yellow', 'player_blue', 'player_red', 'winner_1', 'winner_2', 'winner_3', 'next_player', 'number_of_players', 'rolls_count', 'rolls_times', 'dice_face', 'player_chance', 'has_thrown_dice', 'b0', 'b1', 'b2', 'b3', 'g0', 'g1', 'g2', 'g3', 'r0', 'r1', 'r2', 'r3', 'y0', 'y1', 'y2', 'y3'],
			id: 0,
			created_by: 0,
		...
		GameValue: {
			fieldOrder: ['created_by', 'game_status', 'game_mode', 'player_green', 'player_yellow', 'player_blue', 'player_red', 'winner_1', 'winner_2', 'winner_3', 'next_player', 'number_of_players', 'rolls_count', 'rolls_times', 'dice_face', 'player_chance', 'has_thrown_dice', 'b0', 'b1', 'b2', 'b3', 'g0', 'g1', 'g2', 'g3', 'r0', 'r1', 'r2', 'r3', 'y0', 'y1', 'y2', 'y3'],
			created_by: 0,
		game_status: GameStatus.Pending,
		game_mode: GameMode.SinglePlayer,
			player_green: 0,
